...
export const Header = () => {
  ...
  return (
    <header className={`fixed left-0 right-0 z-40 border-b border-border/50 bg-background/95 backdrop-blur-xl transition-all duration-300 ${bannerVisible ? 'top-[36px] sm:top-[40px] md:top-[44px]' : 'top-0'}`}>
